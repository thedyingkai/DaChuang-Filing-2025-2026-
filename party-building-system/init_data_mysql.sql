-- MySQL 演示数据（来自 init.sql 前 109 行；去掉 PostgreSQL DO 块；保留字列名加反引号）
-- 请先执行仓库根目录的 xxfb_mysql.sql 建好 djpt 表结构，再执行本文件。
SET NAMES utf8mb4;
...
INSERT INTO djpt.activity_view (id, uid, name, `time`, content, `type`, cover_image) VALUES (6, 3, '测试', '2025-02-09 11:54:19', '议程1：……\n议程2：……', 1, 'http://localhost:8081/file/download/8-1.png');
...
-- 题库关键词演示数据（云端新库若未执行则 GET /keywords 返回空列表）
INSERT INTO djpt.column2_o (column_id, column_description) VALUES (1, '党的政策') ON DUPLICATE KEY UPDATE column_description = VALUES(column_description);
INSERT INTO djpt.column2_o (column_id, column_description) VALUES (2, '党的理论') ON DUPLICATE KEY UPDATE column_description = VALUES(column_description);
INSERT INTO djpt.column2_o (column_id, column_description) VALUES (3, '党建活动') ON DUPLICATE KEY UPDATE column_description = VALUES(column_description);
INSERT INTO djpt.keyword_o (keyword_description, column_id) VALUES ('党史', 1);
INSERT INTO djpt.keyword_o (keyword_description, column_id) VALUES ('党章', 1);
INSERT INTO djpt.keyword_o (keyword_description, column_id) VALUES ('党建理论', 2);
INSERT INTO djpt.keyword_o (keyword_description, column_id) VALUES ('组织生活', 3);
