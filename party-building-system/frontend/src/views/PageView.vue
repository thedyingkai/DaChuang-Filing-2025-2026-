  ...
  <el-container style="height: 100vh; border: 1px solid #eee">
    ...
    <el-container>
      <el-aside class="hidden-scrollbar" style="background-color: rgb(238, 241, 246)" width="200px">
        <el-menu>
          <el-menu-item index="0" @click="$router.push('/aichat')">
            <i class="el-icon-cpu" style="color:#d21300"></i>AI 助手
          </el-menu-item>
          <el-submenu index="1">
          ...
          <el-submenu v-if="hasPermission(5)" index="6">
            ...
            <el-menu-item index="6-2" @click="$router.push('/PaperList')">试卷列表</el-menu-item>
            <el-menu-item index="6-3" @click="$router.push('/Choose')">试卷生成</el-menu-item>
            <el-menu-item index="6-4" @click="$router.push('/edit')">试题编辑</el-menu-item>
          </el-submenu>
          <el-submenu v-if="hasPermission(5)" index="7">
